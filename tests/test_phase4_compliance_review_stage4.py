...
def stage4_module(monkeypatch, tmp_path):
    ...
    clear_compliance_review_modules(
        "examples.end-to-end.compliance_review.stage_4_conversational",
    )
