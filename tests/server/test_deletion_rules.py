...
EXPECTED_ONDELETE: dict[tuple[str, str], str | None] = {
    ...
    ("task", "agent_id"): "SET NULL",
    ("task", "agent_version_id"): "SET NULL",
    ("task", "input_session_id"): "SET NULL",
    ("task", "job_id"): "CASCADE",
    ("task", "payload_blob_id"): "SET NULL",
    ("task", "plugin_version_id"): "SET NULL",
    ("task", "result_session_id"): "SET NULL",
