...
async def test_session_import_sends_repeatable_tags_without_wait(
    tmp_path: Path,
) -> None:
    """Import tags travel with asynchronous import work."""
    ...
    assert client.requests[0].tags == ["baseline", "discovery"]
