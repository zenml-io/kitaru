...
From the repository root, use Node 22.22 or newer within Node 22, Node 24, or Node 26, plus pnpm 10.33, uv, and local PostgreSQL reachable by the repository's [devtools harness](../../../devtools/AGENTS.md). Docker can provide PostgreSQL when it is not already running.
