...
- **Replay a stateful PydanticAI support agent against a candidate version:** `examples/end_to_end/replay_fork_demo/`
...
- [end_to_end/replay_fork_demo/README.md](end_to_end/replay_fork_demo/README.md): case-first trace import and candidate replay with a stateful PydanticAI support agent
...
| [Case-first PydanticAI replay](end_to_end/replay_fork_demo/README.md) | `cd examples/end_to_end/replay_fork_demo && uv run python demo.py import-traces langfuse://trace/<TRACE_ID>` | Upcoming registration and trace-import SDK primitives + Langfuse credentials | Import a reported production trace, investigate the resulting execution, then replay the wrapped PydanticAI agent over one case or a filtered cohort | [Replay and Overrides](https://docs.zenml.io/kitaru/guides/replay-and-overrides) | [tests/test_replay_fork_demo.py](../tests/test_replay_fork_demo.py) |
