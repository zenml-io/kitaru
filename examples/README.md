...
- [integrations/openai_agents_agent/README.md](integrations/openai_agents_agent/README.md) — wrap an OpenAI Agents SDK agent with Kitaru call-level or runner-level durability
