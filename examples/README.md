...
13. `uv run python examples/integrations/openai_agents_agent/openai_agents_sandbox_tool.py` *(OpenAI agent calls the active stack's sandbox command tool; requires `OPENAI_API_KEY` and one active sandbox)*
