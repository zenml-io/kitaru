...
|---|---|---|---|
| [first_working_flow.py](first_working_flow.py) | `uv run python examples/features/basic_flow/first_working_flow.py` | Smallest end-to-end `@flow` + `@checkpoint` example | — |
| [flow_with_logging.py](flow_with_logging.py) | `uv run python examples/features/basic_flow/flow_with_logging.py` | `kitaru.log()` metadata at flow and checkpoint scope | — |
| [flow_with_artifacts.py](flow_with_artifacts.py) | `uv run python examples/features/basic_flow/flow_with_artifacts.py` | Named artifact save/load across executions | — |
| [flow_with_configuration.py](flow_with_configuration.py) | `uv run python examples/features/basic_flow/flow_with_configuration.py` | Runtime config defaults, overrides, and frozen execution specs | — |
