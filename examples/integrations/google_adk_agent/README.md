...
- `turn`, `usage`, `estimated_cost_usd`, and `model` — live-mode event summary, token usage when ADK reports it, Kitaru's estimated USD cost when the model is priceable, and the selected Gemini/Vertex model.
