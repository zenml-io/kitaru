...
Manual workflow dispatches build and test without publishing. A package tag selects the package and version. The workflow publishes only when the tagged commit is contained in `main`.
