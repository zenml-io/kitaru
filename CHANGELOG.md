...
- Stack creation internals now share one CLI/MCP validation layer across local, Kubernetes, and Vertex flows, and `kitaru stack show` / structured stack inspection now classify Vertex stacks explicitly and surface the runner `location`
