...
### Added
- Added caller-owned Gemini custom function execution through Kitaru's active sandbox, with explicit registered sandbox commands, a dry-run example showcase, and docs that keep Antigravity / Google-owned tool internals outside Kitaru's replay promise. (#433)
