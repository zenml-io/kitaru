...
- Kept the Claude Agent SDK sandbox MCP helper's default output limits and serialized JSON tool results within Claude Code's MCP result-size ceiling, so Kitaru's stdout/stderr truncation flags match what Claude actually receives.
