...
### Added
- The PydanticAI recording and replay adapter is included in the Kitaru wheel and installed with the `pydantic-ai` extra. Import it from `kitaru.adapters.pydantic_ai`.
