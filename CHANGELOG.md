...
### Fixed
- Server images now serve the UI bundled in the installed Kitaru package at the root URL, including client-side routes such as device verification, while preserving API 404 responses.
