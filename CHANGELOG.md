...
- Added best-effort token usage and estimated-cost recording for fast-agent adapter model-call checkpoints, including custom cost calculator support and OpenAI Responses pricing aliases.
