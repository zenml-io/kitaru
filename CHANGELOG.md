...
- Stack creation internals now share one CLI/MCP validation layer and a widened remote-stack dispatcher, adding future Vertex/SageMaker/AzureML scaffolding without exposing those stack types in the current CLI or MCP surface yet
