...
- Added a `--show-text-deltas` opt-in on the Gemini Interactions example so manual streaming tests can print clipped Gemini text chunks in the terminal while keeping live-event text hidden by default.
