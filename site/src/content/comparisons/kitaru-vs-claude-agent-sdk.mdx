...
<ComparisonTable
  ...
  rows={[
    ...
    {
      feature: "Versioned memory across runs",
      kitaru: "yes",
      competitor: "partial",
      note: "The SDK resumes per-session conversation context. Kitaru exposes scoped, versioned state from Python, CLI, and MCP.",
    },
    {
