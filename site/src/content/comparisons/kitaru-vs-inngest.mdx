---
competitor: "Inngest"
competitorLogo: "https://assets.kitaru.ai/compare/17dda213/inngest.avif"
...
import RuntimeUnderHarness from '../../components/compare/graphics/inngest/RuntimeUnderHarness.astro';
import AgentPrimitives from '../../components/compare/graphics/inngest/AgentPrimitives.astro';
import CustomerDataPath from '../../components/compare/graphics/inngest/CustomerDataPath.astro';
import ArtifactLineage from '../../components/compare/graphics/inngest/ArtifactLineage.astro';
...
| Determinism requirement | Side effects must live inside `step.run` to be memoized on replay | No constraint; `@flow` and `@checkpoint` are plain Python, side effects anywhere |
