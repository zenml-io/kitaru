...
So I built myself a small agent. It reads across a few sources, scores what it finds, and prints a short brief I can read in two minutes. I put it on Kitaru and PydanticAI mostly because we use Kitaru ourselves and I wanted a non-trivial example to break, replay, and poke at on a real workload. The full thing lives at [examples/end-to-end/news_scout](https://github.com/zenml-io/kitaru/tree/develop/examples/end-to-end/news_scout).
...
# Drop your keys in examples/end-to-end/news_scout/.env, then:
