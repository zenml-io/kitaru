...
image: "https://assets.kitaru.ai/content/blog/8975e15d/why-agents-need-durable-execution.avif"
---
...
Then the OpenAI API returned a 429. Your agent crashed. All that work — gone.
...
This is fine for short tasks. A single LLM call that fails? Retry it. But agents are getting longer and more complex:
