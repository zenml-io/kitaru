...
**Infrastructure abstraction.** "This code runs on my laptop and on Kubernetes with zero changes." Same principle in Kitaru — `pip install kitaru` locally, `kitaru runner use prod` for your cloud.
