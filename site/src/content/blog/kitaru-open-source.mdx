...
image: "https://assets.kitaru.ai/content/blog/9f8bd61e/kit-launch.avif"
---
...
**Richer run-to-run context patterns**: teams keep asking for better ways to carry useful context from one execution into the next without rebuilding a separate state layer for every agent. We are still shaping the right Kitaru-native answer here, and we would rather ship the honest primitive than overpromise it early.
