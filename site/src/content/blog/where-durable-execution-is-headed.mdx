...
author: "Hamza Tahir"
category: "Design"
ogImage: "https://assets.kitaru.ai/content/blog/where-durable-execution-is-headed/7d7b380e/where-durable-execution-is-headed-cover.avif"
image: "https://assets.kitaru.ai/content/blog/where-durable-execution-is-headed/7d7b380e/where-durable-execution-is-headed-cover.avif"
---
...
![Absurd's checkpoint-based replay model: only completed steps are restored from Postgres; ordinary code between steps may run again.](https://assets.kitaru.ai/content/blog/where-durable-execution-is-headed/0fa20004/absurd-checkpoint.avif)
...
![Temporal's deterministic replay model: workflow code is rerun against a recorded Event History and must issue the same Commands in the same order.](https://assets.kitaru.ai/content/blog/where-durable-execution-is-headed/320166c5/temporal-replay.avif)
...
![Pull versus push scheduling: workers pulling work from Postgres versus a coordinator pushing work to workers.](https://assets.kitaru.ai/content/blog/where-durable-execution-is-headed/ec7c22c3/push-pull.avif)
...
![Where Kitaru sits relative to Absurd and Temporal: checkpoint-based replay, no long-lived workers, infrastructure provided by an orchestrator the team already runs.](https://assets.kitaru.ai/content/blog/where-durable-execution-is-headed/93994d91/where-kitaru-sits.avif)
