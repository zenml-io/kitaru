...
**Harness.** How the agent thinks. Prompts, tool loops, model calls, structured output, context management, in-turn memory. Pydantic AI, LangGraph, Deep Agents, the Claude Agent SDK, the OpenAI Agents SDK, hand-rolled loops. Harness design is a very active area. This is where reasoning quality lives.
