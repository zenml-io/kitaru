...
> **Before building**: If the workflow shape is still fuzzy, scope the
> architecture first. Make checkpoint boundaries, wait points, and replay
> anchors explicit before writing implementation code.
