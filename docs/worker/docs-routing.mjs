...
export const RETIRED_DOCS_REDIRECTS = [
  ...
  [`${DOCS_PREFIX}/guides/pydantic-ai-adapter.md`, `${DOCS_PREFIX}/adapters/pydantic-ai.md`],
  [`${DOCS_PREFIX}/guides/openai-agents-adapter`, `${DOCS_PREFIX}/adapters/openai-agents/`],
  [`${DOCS_PREFIX}/guides/openai-agents-adapter.md`, `${DOCS_PREFIX}/adapters/openai-agents.md`],
  [`${DOCS_PREFIX}/guides/claude-agent-sdk-adapter`, `${DOCS_PREFIX}/adapters/claude-agent-sdk/`],
  [`${DOCS_PREFIX}/guides/claude-agent-sdk-adapter.md`, `${DOCS_PREFIX}/adapters/claude-agent-sdk.md`],
  [`${DOCS_PREFIX}/guides/gemini-interactions-adapter`, `${DOCS_PREFIX}/adapters/gemini-interactions/`],
  [`${DOCS_PREFIX}/guides/gemini-interactions-adapter.md`, `${DOCS_PREFIX}/adapters/gemini-interactions.md`],
  [`${DOCS_PREFIX}/guides/langgraph-adapter`, `${DOCS_PREFIX}/adapters/langgraph/`],
  [`${DOCS_PREFIX}/guides/langgraph-adapter.md`, `${DOCS_PREFIX}/adapters/langgraph.md`],
];
