...
If you only want to make one function durable, start with the [Quickstart](../getting-started/quickstart.md). Come back here when you want to see how the same Kitaru primitives fit into a larger internal platform shape.
