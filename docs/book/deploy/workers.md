...
| `KITARU_WORKER_ID` | none | Id of a worker the server pre-registered. Skips registration, adopts the stored scope, and uses `KITARU_API_TOKEN` as is. Not combinable with claim, selector, or job id flags. |
