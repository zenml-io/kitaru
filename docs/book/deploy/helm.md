...
Server settings go under `kitaru.server`. For the full list of available options,
see the
...
See [Authentication](../guides/authentication.md) for the full service-account/API-key
flow and how it relates to `kitaru auth token`.
