...
The fastest way to run this loop for real is to let your coding assistant drive it. Install the [Kitaru agent skills](../agent-native/README.md), open your agent repository in Claude Code, Codex, or Cursor, and ask:
