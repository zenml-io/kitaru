...
For a runnable version of this pattern inside a tracked Kitaru flow, see the [active stack sandbox command example](https://github.com/zenml-io/kitaru/blob/develop/examples/features/sandbox/active_stack_sandbox_command.py) in the repository.
