...
For a runnable version of this pattern inside a tracked Kitaru flow, see the [active stack sandbox command example](../getting-started/examples.md#core-workflow-basics).
