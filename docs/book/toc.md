...
- [Complete returns-agent tutorial](tutorials/returns-agent/README.md)
  ...
  - [2. Judge what should have happened](tutorials/returns-agent/judge.md)
  - [3. Define the regression test](tutorials/returns-agent/define.md)
  - [4. Replay the changed agent](tutorials/returns-agent/replay.md)
  - [5. Compare the evidence](tutorials/returns-agent/compare.md)
