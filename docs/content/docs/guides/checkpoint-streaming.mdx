...
See [PydanticAI Adapter](/guides/pydantic-ai-adapter/#streaming),
[OpenAI Agents Adapter](/guides/openai-agents-adapter/#streaming-with-kitaru-durability),
[Claude Agent SDK Adapter](/guides/claude-agent-sdk-adapter/#live-streaming-with-kitaru-durability),
and [LangGraph Adapter](/guides/langgraph-adapter/#graph-call-streaming) for
