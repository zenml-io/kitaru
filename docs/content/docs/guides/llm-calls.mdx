...
original output handle. See [In flow bodies](/guides/artifacts#in-flow-bodies)
...
[`examples/end-to-end/coding_agent/`](https://github.com/zenml-io/kitaru/tree/develop/examples/end-to-end/coding_agent).
