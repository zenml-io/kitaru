...
This page covers the general stack story: current stack, switching, local stack creation, remote stack creation, deletion, and precedence. If you want the end-to-end workflow for a Kubernetes-backed stack, use [Kubernetes Stacks](/infrastructure/kubernetes-stacks).
