...
A [stack](/infrastructure/stacks) is a named runtime for your agent — it bundles compute, storage, and a container registry. This page covers creating, switching, inspecting, and deleting stacks.

For the end-to-end Kubernetes setup, see [Kubernetes Stacks](/infrastructure/kubernetes-stacks).
