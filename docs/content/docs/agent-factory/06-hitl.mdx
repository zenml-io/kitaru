...
That's the end of the tour. Memory and replay aren't covered as separate chapters here — they're general Kitaru primitives that apply uniformly to any flow, not platform-engineering capabilities specific to agent factories. See [Memory](/guides/memory) and [Replay and Overrides](/guides/replay-and-overrides) when you want those.
