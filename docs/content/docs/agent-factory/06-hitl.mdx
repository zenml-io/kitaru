...
That's the end of the currently-shipped tour. The example also has runnable foundations for memory-backed remembered choices and replay-with-overrides; those chapters land in docs once the corresponding stage files do.
