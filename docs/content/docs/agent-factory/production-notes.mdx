...
|---|---|---|---|
| Durable execution (Stage 1) | `granular_checkpoints=False` for readable logs | The `KitaruAgent` default: granular checkpoints for model requests and tool calls | the `granular_checkpoints` flag |
