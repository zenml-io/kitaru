...
A stack is Kitaru's user-facing name for a ZenML stack. It is your execution target: when you run a flow without passing `stack=...`, Kitaru uses the active stack.
