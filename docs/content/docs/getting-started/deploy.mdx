...
<Cards>
  ...
  <Card
    title="Run with Dapr"
    description="Use the experimental Dapr engine with a local Dapr sidecar"
    href="/deploy/dapr-engine"
  />
</Cards>
...
A [stack](/stacks) is a named runtime that tells Kitaru where
