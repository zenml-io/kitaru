...
<Cards>
  <Card
    title="Agent Factory"
    description="The recommended end-to-end tour: build a durable agent platform stage by stage on Kitaru + PydanticAI"
    href="/getting-started/examples#start-here--agent-factory"
  />
  <Card
    title="Core Concepts"
