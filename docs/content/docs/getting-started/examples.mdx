...
| `execution_management/wait_and_resume.py` | `kitaru.wait()` with inline prompt or CLI input/resume | [Wait and Resume](/guides/wait-and-resume) |
...
5. `execution_management/wait_and_resume.py` — [Wait and Resume](/guides/wait-and-resume)
