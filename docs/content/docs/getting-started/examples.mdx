...
| Seed and inspect durable memory across scopes | `memory/` | `python flow_with_memory.py` |
...
| Example | Demonstrates | Related docs |
|---|---|---|
| `memory/flow_with_memory.py` | Outside-flow seeding, in-flow `kitaru.memory`, and explicit-scope inspection with `KitaruClient.memories` | [Use Memory](/guides/memory) |
