...
8. `integrations/pydantic_ai_agent/pydantic_ai_adapter.py` — [PydanticAI Adapter](/adapters/pydantic-ai/).
9. `integrations/openai_agents_agent/openai_agents_adapter.py` — [OpenAI Agents Adapter](/adapters/openai-agents/).
10. `integrations/claude_agent_sdk_agent/claude_agent_sdk_adapter.py` — [Claude Agent SDK Adapter](/adapters/claude-agent-sdk/).
11. `integrations/gemini_interactions_agent/gemini_interactions_adapter.py` — [Gemini Interactions Adapter](/adapters/gemini-interactions/).
12. `integrations/langgraph_agent/langgraph_adapter.py` — [LangGraph Adapter](/adapters/langgraph/).
13. `end_to_end/openai_research_bot/research_bot.py` — [Research bot](/adapters/openai-agents/#end-to-end-research-bot-example).
