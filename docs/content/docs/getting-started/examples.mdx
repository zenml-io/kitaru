...
| Wrap a Claude Agent SDK invocation | `integrations/claude_agent_sdk_agent/` | `python claude_agent_sdk_adapter.py` |
...
12. `end_to_end/openai_research_bot/research_bot.py` — [Research bot section](/guides/openai-agents-adapter#end-to-end-research-bot-example)
