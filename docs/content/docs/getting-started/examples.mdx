...
| Example | Demonstrates | Related docs |
|---|---|---|
| `memory/flow_with_memory.py` | Outside-flow seeding, in-flow `kitaru.memory`, explicit-scope inspection, and post-run maintenance (compact, purge, audit log) via `KitaruClient.memories` | [Use Memory](/guides/memory) |
