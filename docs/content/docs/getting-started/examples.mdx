...
8. **[Agent Factory](https://github.com/zenml-io/kitaru/tree/develop/examples/end_to_end/agent_factory)** — the same primitives, woven into one runnable agent platform.
