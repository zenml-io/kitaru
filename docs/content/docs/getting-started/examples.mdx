...
10. `end_to_end/openai_research_bot/research_bot.py` — [Research bot](/guides/openai-agents-adapter#end-to-end-research-bot-example).
11. `features/mcp/mcp_query_tools.py` — [MCP Server](/agent-native/mcp-server).
12. **[Agent Factory](/agent-factory)** — the same primitives, woven into one runnable agent platform.
