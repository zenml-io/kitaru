...
<Cards>
  <Card title="Execution Architecture" href="/concepts/execution-architecture" description="Three planes, inline vs isolated, orchestrator vs sandbox." />
  <Card title="How It Works" href="/concepts/how-it-works" description="Agent runtime, server, client — what lives where." />
