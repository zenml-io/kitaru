...
def start_or_connect_local_server(
    *,
    ...
    if local_server is not None:
        ...
        is_running = bool(getattr(local_server, "is_running", False) and existing_url)
    ...
    resolved_port = port or _DEFAULT_LOCAL_SERVER_PORT
    ...
    deployed_url = (
        ...
        or f"http://{_DEFAULT_LOCAL_SERVER_HOST}:{resolved_port}"
    )
