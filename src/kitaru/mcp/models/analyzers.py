...
"""Strict analyzer parent and version management inputs."""
...
class AnalyzerCreate(MCPModel):
    """Create an analyzer parent."""
...
class AnalyzerUpdate(MCPModel):
    """Sparsely update an analyzer parent."""
...
class AnalyzerVersionCreate(MCPModel):
...
class AnalyzerVersionUpdate(MCPModel):
    """Set or clear one analyzer version display label."""
    ...
    @model_validator(mode="after")
    def _validate_update(self) -> "AnalyzerVersionUpdate":
...
AnalyzersManageRequest = Annotated[
    AnalyzerCreate | AnalyzerUpdate | AnalyzerVersionCreate | AnalyzerVersionUpdate,
