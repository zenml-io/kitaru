...
DEFAULT_PLUGIN_DEFINITIONS: tuple[DefaultPluginDefinition, ...] = (
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-braintrust-importer==0.3.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-jsonl-importer==0.1.2",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-logfire-importer==0.3.0",
        display_version="0.3.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-langsmith-importer==0.3.0",
        display_version="0.3.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-phoenix-importer==0.3.0",
        display_version="0.3.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-evaluator==0.1.3",
