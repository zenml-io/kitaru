...
DEFAULT_PLUGIN_DEFINITIONS: tuple[DefaultPluginDefinition, ...] = (
    DefaultPluginDefinition(
        ...
        requirement="kitaru-post-import-insights==0.1.1",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-post-import-insights[openai]==0.1.1",
        display_version="0.1.1",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-braintrust-importer==0.4.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-jsonl-importer==0.2.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-langfuse-importer==0.4.0",
        display_version="0.4.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-logfire-importer==0.4.0",
        display_version="0.4.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-phoenix-importer==0.4.0",
        display_version="0.4.0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-evaluator==0.2.0",
        display_version="0.2.0",
    ),
    DefaultPluginDefinition(
        kind=PluginKind.EVALUATOR,
