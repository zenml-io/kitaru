...
DEFAULT_PLUGIN_DEFINITIONS: tuple[DefaultPluginDefinition, ...] = (
    DefaultPluginDefinition(
        ...
        requirement="kitaru-braintrust-importer==0.1.1",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-langsmith-importer==0.1.1",
        display_version="0.1.1",
    ),
    DefaultPluginDefinition(
        kind=PluginKind.IMPORTER,
        ...
        requirement="kitaru-opentelemetry-importer==0.1.1",
        display_version="0.1.1",
    ),
    DefaultPluginDefinition(
        ...
        requirement="kitaru-evaluator==0.1.1",
        display_version="0.1.1",
    ),
    DefaultPluginDefinition(
        kind=PluginKind.EVALUATOR,
