...
DEFAULT_PLUGIN_DEFINITIONS: tuple[DefaultPluginDefinition, ...] = (
    DefaultPluginDefinition(
        ...
        requirement="kitaru-braintrust-importer==0.1.0rc0",
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-jsonl-importer==0.1.0rc0",
        display_version="0.1.0rc0",
    ),
    DefaultPluginDefinition(
        kind=PluginKind.IMPORTER,
    ...
    DefaultPluginDefinition(
        ...
        requirement="kitaru-langsmith-importer==0.1.0rc0",
        display_version="0.1.0rc0",
    ),
    DefaultPluginDefinition(
        ...
        requirement="kitaru-evaluator==0.1.0rc0",
        display_version="0.1.0rc0",
    ),
    DefaultPluginDefinition(
        kind=PluginKind.EVALUATOR,
