...
class ReplayService:
    ...
    async def create_replay(
        ...
        Raises:
            ...
            ValidationError: The baseline session carries no agent version
                ...
                spec, or the config uses cohort-scoped history.
    ...
    async def _find_history_node(
        ...
        return await self._session_nodes.find_latest_by_cache_key_in_cohort(
            run.cohort_id, cache_key
        )
