...
class TagLinkNotFound(NotFoundError):
    ...
    def __init__(
        ...
        """
        super().__init__(
            f"Tag {tag_id} is not attached to {resource_type} {resource_id}"
        )


class DuplicateTagLink(ConflictError):
    """Raised when a tag link is already registered."""
    ...
    def __init__(
        ...
        """
        super().__init__(
            f"Tag {tag_id} is already attached to {resource_type} {resource_id}"
        )
