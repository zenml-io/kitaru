...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        TagResourceType: "session" | "cohort" | "experiment" | "experiment_run";
        /**
         * TagResponse
        ...
        TaskUpdateRequest: {
            /**
             * Attempt
             * @description Attempt this transition is fenced by.
             */
            attempt?: number | null;
            /**
             * Error
    ...
    list_accounts_v1_accounts_get: {
        parameters: {
            query?: {
                ...
                sort?: string;
                /** @description Filter on account name. */
                name?: string | null;
                /** @description Filter on active state. */
                active?: boolean | null;
            };
            header?: never;
            path?: never;
    ...
    list_api_keys_v1_api_keys_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on API key name. */
                name?: string | null;
            };
            header?: never;
            path?: never;
    ...
    list_cohorts_v1_cohorts_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on cohort name. */
                name?: string | null;
    ...
    list_devices_v1_devices_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on device status. */
    ...
    list_evaluations_v1_evaluations_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on session. */
                session_id?: string | null;
                /** @description Filter on evaluator task. */
                task_id?: string | null;
                /** @description Filter on evaluator version. */
                evaluator_version_id?: string | null;
                /** @description Filter on evaluation name. */
                name?: string | null;
                /** @description Filter on data type. */
                data_type?: components["schemas"]["EvaluationDataType"] | null;
            };
            header?: never;
            path?: never;
            cookie?: never;
    ...
    list_evaluators_v1_evaluators_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on evaluator name. */
                name?: string | null;
            };
            header?: never;
            path?: never;
    ...
    list_experiment_runs_v1_experiment_runs_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on experiment. */
                experiment_id?: string | null;
                /** @description Filter on run status. */
                status?: components["schemas"]["ExperimentRunStatus"] | null;
                /** @description Filter on tag name. */
                tag?: string | null;
            };
            header?: never;
    ...
    list_experiment_run_jobs_v1_experiment_runs__experiment_run_id__jobs_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on job status. */
    ...
    list_experiments_v1_experiments_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on experiment name. */
                name?: string | null;
                /** @description Filter on tag name. */
                tag?: string | null;
            };
    ...
    list_importers_v1_importers_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on importer name. */
                name?: string | null;
                /** @description Filter on source system. */
                provider?: string | null;
            };
            header?: never;
            path?: never;
    ...
    list_job_tasks_v1_jobs__job_id__tasks_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on task kind. */
    ...
    list_replays_v1_replays_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on experiment run. */
                experiment_run_id?: string | null;
                /** @description Filter on baseline session. */
                baseline_session_id?: string | null;
                /** @description Filter on replay status. */
                status?: components["schemas"]["ReplayStatus"] | null;
            };
            header?: never;
            path?: never;
            cookie?: never;
    ...
    list_secrets_v1_secrets_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on secret name. */
                name?: string | null;
            };
            header?: never;
            path?: never;
    ...
    list_sessions_v1_sessions_get: {
        parameters: {
            query?: {
                ...
                origin?: components["schemas"]["SessionOrigin"] | null;
                /** @description Filter on session status. */
                status?: components["schemas"]["SessionStatus"] | null;
                /** @description Filter on source system. */
                provider?: string | null;
                /** @description Filter on source system id. */
                external_id?: string | null;
                /** @description Filter on session name. */
                name?: string | null;
                /** @description Filter on tag name. */
                tag?: string | null;
                /** @description Filter on sessions started at or after this time. */
                started_after?: string | null;
                /** @description Filter on sessions started before this time. */
                started_before?: string | null;
                /** @description Filter on sessions ended at or after this time. */
                ended_after?: string | null;
                /** @description Filter on sessions ended before this time. */
                ended_before?: string | null;
                /** @description Filter on whether the session has an evaluation. */
                has_evaluation?: boolean | null;
                /** @description Filter on minimum cost. */
                min_cost?: number | string | null;
                /** @description Filter on maximum cost. */
    ...
    list_tasks_v1_tasks_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on owning job. */
                job_id?: string | null;
                /** @description Filter on task kind. */
                kind?: components["schemas"]["TaskKind"] | null;
                /** @description Filter on task status. */
                status?: components["schemas"]["TaskStatus"] | null;
                /** @description Filter on the claiming worker. */
                worker_id?: string | null;
            };
            header?: never;
            path?: never;
    ...
    list_workers_v1_workers_get: {
        parameters: {
            query?: {
                ...
                /** @description Sort field and direction, as field:asc or field:desc. */
                sort?: string;
                /** @description Filter on worker name. */
                name?: string | null;
            };
            header?: never;
            path?: never;
